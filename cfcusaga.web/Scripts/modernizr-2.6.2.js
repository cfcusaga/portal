...
window.Modernizr = (function( window, document, undefined ) {
    ...
    function testDOMProps( props, obj, elem ) {
        for ( var i in props ) {
            ...
            if ( item !== undefined) {
                ...
                // return the property userName as a string
    ...
    // userName has been deprecated in favor of a shorter and property-matching one.
    ...
    /*jshint evil:true */
       ...
       * @memberOf html5
       * @param {String} nodeName userName of the element
      ...
      function createElement(nodeName, ownerDocument, data){
        ...
        // * Attributes like `userName` or `type` cannot be set/changed once an element
    ...
    /*>>prefixed*/
    // Modernizr.prefixed() returns the prefixed or nonprefixed property userName variant of your input
